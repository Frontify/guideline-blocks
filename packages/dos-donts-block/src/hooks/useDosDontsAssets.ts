...
import { type Asset, type AppBridgeBlock, useAssetChooser, useAssetUpload, useFileInput } from '@frontify/app-bridge';
import { AssetChooserObjectType, FileExtensionSets } from '@frontify/guideline-blocks-settings';
import { useEffect, useState } from 'react';

import { type ChangeType, type ValueType } from '../types';

type UseDosDontsAssetsProps = {
    id: string;
...
export const useDosDontsAssets = ({
    id,
    appBridge,
    alt,
    onChangeItem,
    updateAssetIdsFromKey,
}: UseDosDontsAssetsProps) => {
    ...
    return { onOpenAssetChooser, onUploadClick, isUploadLoading, localAltText, setLocalAltText };
};
