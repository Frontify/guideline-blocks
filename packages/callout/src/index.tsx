...
const CalloutBlock: FC<CalloutBlockProps> = ({ appBridge }) => {
  ...
  useEffect(() => {
    const paddingStyle = customPaddingSwitch ?  {paddingTop: customPadding[0], paddingRight: customPadding[2], paddingBottom: customPadding[3], paddingLeft: customPadding[1]} : undefined;
    const cornerRadiusStyle = customCornerRadiusSwitch ? {borderRadius: `${customCornerRadius[0]} ${customCornerRadius[1]} ${customCornerRadius[3]} ${customCornerRadius[2]}`} : undefined;
