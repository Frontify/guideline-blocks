...
export const LottieBlock = withAttachmentsProvider(({ appBridge }: BlockProps) => {
    ...
    const onRemoveAsset = () => {
        setBlockSettings({ altText: undefined, lottieUrl: null });
                                ...
                                >
                                    {urlIsLoading || uploadIsLoading ? (
                                        ...
                                        <Image
                                            ...
                                            isEditing={isEditing}
                                            imageSource={image || blockSettings.lottieUrl}
