...
export type DynamicSettingBlock<T extends DynamicSupportedBlocks> = Omit<T, 'value'> & {
...
export declare type SettingBlock = SimpleSettingBlock | DynamicSettingBlock<DynamicSupportedBlocks>;
