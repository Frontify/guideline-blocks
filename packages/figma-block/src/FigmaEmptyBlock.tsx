...
export const FigmaEmptyBlock = ({ onOpenAssetChooser }: Props): ReactElement => {
    return (
        <button
            ...
            className="tw-group tw-w-full tw-py-16 tw-px-4 tw-border-dashed tw-border tw-cursor-pointer tw-text-center tw-border-line-x-strong hover:tw-border-[var(--f-theme-settings-body-color)]"
