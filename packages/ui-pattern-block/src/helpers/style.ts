...
import { Radius, getBackgroundColorStyles, radiusStyleMap } from '@frontify/guideline-blocks-settings';
import { Height, Padding, heightValues, paddingValues } from '../types';
import { Color } from '@frontify/fondue';

export const EDITOR_CLASSES = {
    'sp-layout': 'tw-gap-0 tw-border-none tw-rounded-none',
    'sp-code-editor': 'tw-border-b tw-border-line',
...
export const getRadiusStyle = (hasRadius: boolean, radiusValue: number | undefined, radiusChoice: Radius) => {
    return hasRadius ? radiusValue : radiusStyleMap[radiusChoice];
};
