...
export const JsonErrorMessage = (): ReactElement => {
    return (
        <div
            ...
            className="tw-text-container-error-on-error-container tw-w-full tw-h-11 tw-flex tw-items-center tw-px-3 tw-gap-3 tw-bg-container-error tw-text-small tw-font-medium tw-font-sans"
        >
