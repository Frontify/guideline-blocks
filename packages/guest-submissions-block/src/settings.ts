        ...
        basics: [
            {
                ...
                type: 'dropdown',
                label: 'Library',
                info: 'Can’t find your library? Turn on Asset submissions in your library settings.',
        ...
        Form: [
            {
                ...
                type: 'switch',
                defaultValue: true,
                info: 'Turn on disclaimer to require users to accept before submitting the form.',
                label: 'Disclaimer',
            },
        ],
        Metadata: [
