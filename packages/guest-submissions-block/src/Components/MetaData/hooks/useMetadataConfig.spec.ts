...
const testObjectNoConfiguration = {
    ...
    assetSubmission:
        "eyJpZGVudGlmaWVyIjoxLCJ0eXBlIjoiYXNzZXRTdWJtaXNzaW9uUmVxdWVzdCJ9",
    "New Summer Field Name--#--eyJpZGVudGlmaWVyIjoxMiwidHlwsdZSI6ImN1c3RvbU1ldGFkYXRhUHJvcGVydHkifQ==":
        true,
    ...
    "Winter Queryy--#--eyJpZGVudGlmaWVyIjoxaggaaMiwidHlwZSI6ImN1c3RvbU1ldGFkYXRhUHJvcGVydHkifQ==":
        false,
    "Winter Queryy--#--eyJpZGVudGlmaWVyIjoxaggaaMiwidHlwZSI6ImN1c3RvbU1ldGFkYXRhUHJvcGVydHkifQ==--#--required":
        false,
    "Winter Queryy--#--eyJpZGVudGlmaWVyIjoxaggaaMiwidHlwZSI6ImN1c3RvbU1ldGFkYXRhUHJvcGVydHkifQ==--#--label":
        "",
    "Single Select--#--eyJpZGVudGlmaWVasasayIjoxNSwidHlwZSI6ImN1c3RvbU1ldGFkYXRhUHJvcGVydHkifQ==":
        false,
    "Single Select--#--eyJpZGVudGlmaWVasasayIjoxNSwidHlwZSI6ImN1c3RvbU1ldGFkYXRhUHJvcGVydHkifQ==--#--required":
        false,
    "Campaign Description--#--eyJpZGVudfsfsfGlmaWVyIjoxMywidHlwZSI6ImN1c3RvbU1ldGFkYXRhUHJvcGVydHkifQ==":
        false,
