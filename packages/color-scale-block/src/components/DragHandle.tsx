...
export const DragHandle: FC<DragHandleProps> = ({ index, currentColor, isEditing, onResizeStart }) => {
    ...
    return (
        <>
            {isEditing ? (
                <div
                    className="tw-absolute tw-opacity-0 hover:tw-opacity-100 group-hover:tw-flex tw-w-8 tw-flex tw-h-full tw-items-center tw-right-[-16px] tw-cursor-move tw-z-[99]"
