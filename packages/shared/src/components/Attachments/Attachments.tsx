                    ...
                    triggerElement={
                        <div data-test-id="attachments-flyout-button">
                            <Flyout
                                ...
                                legacyFooter={false}
                                trigger={
                                    <div className="tw-flex -tw-mx-3 tw-text-[13px] tw-font-body tw-items-center tw-gap-1 tw-rounded-full tw-bg-box-neutral-strong-inverse hover:tw-bg-box-neutral-strong-inverse-hover active:tw-bg-box-neutral-strong-inverse-pressed tw-text-box-neutral-strong tw-p-[6px] tw-outline-line">
                                        <IconPaperclip16 />
